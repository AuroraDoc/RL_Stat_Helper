...
# might want to add in the ball stat later if we can get possession and pressure percentages
        for idx in range(0, team_size-1):
            player = {"name": data["blue"]["players"][idx]["name"],
                     ...
                     "amount_used_while_supersonic": data["blue"]["players"][idx]["stats"]["boost"]["amount_used_while_supersonic"],
                     "count_collected_big": data["blue"]["players"][idx]["stats"]["boost"]["count_collected_big"],
                     "count_collected_small": data["blue"]["players"][idx]["stats"]["boost"]["count_collected_small"],
                     "avg_speed": data["blue"]["players"][idx]["stats"]["movement"]["avg_speed"],
        ...
        for idx in range(0, team_size-1):
            player = {"name": data["orange"]["players"][idx]["name"],
                     ...
                     "amount_used_while_supersonic": data["orange"]["players"][idx]["stats"]["boost"]["amount_used_while_supersonic"],
                     "count_collected_big": data["orange"]["players"][idx]["stats"]["boost"]["count_collected_big"],
                     "count_collected_small": data["orange"]["players"][idx]["stats"]["boost"]["count_collected_small"],
                     "avg_speed": data["orange"]["players"][idx]["stats"]["movement"]["avg_speed"],
            ...
            player.clear()
        game = {"blue": blue_team,
               "orange": orange_team} # like this with the players
        return game
def main():
